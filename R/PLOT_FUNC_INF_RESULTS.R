...
# FIXED 3
PLOT_CI_PARAMS_FIXED_III <- function(df_results, COMP_FOLDER, fig_num = '1',
                                    num_days = 50, cex = 1.0, num_conds = 5,
                                    PDF = FALSE, 
                                    FIXED_PARAM = list(r0 = FALSE, k = FALSE,
                                                       alpha = FALSE, gamma = FALSE, c = FALSE),
  ...
  if(FLAG_FILTER$tot_infs){
    legend_list <- c(paste0(fixed_param, " True "),
                     paste0(fixed_param, " post. mean, infs: [5, 10]"),
                     paste0(fixed_param, " post. mean, infs: [10, 100]"),
                     paste0(fixed_param, " post. mean, infs: [100, 1k]"),
                     paste0(fixed_param, " post. mean, infs: [1k, 10k]"),
                     paste0(fixed_param, " post. mean, infs: [10k, 100k]"),
                     paste0(fixed_param, " post. mean, infs > 100k"))
  }
