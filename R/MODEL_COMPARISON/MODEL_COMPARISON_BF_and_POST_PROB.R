...
#* 
#***********************************************************
GET_POSTERIOR_MODEL_PROB <- function(num_models = 3, log_model_evidence = list(mod1 = mod1, mod2 = mod2,
                                                                               mod3 = mod3), probs_models){  #probs_models = list(prob_mech1 = 0.25, prob_mech2 = 0.5, prob_mech3 = 0.25),
