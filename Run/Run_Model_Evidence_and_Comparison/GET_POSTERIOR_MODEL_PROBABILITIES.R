...
#MODEL 1: BASE
#***********************
vec_post_probs_hm = GET_AGG_POSTERIOR_PROB(list_log_mod_evid = list(mod1 = list_is_log_ev_base,
...
#MODEL 2: SSEB
#***********************
vec_post_probs_hm2 = GET_AGG_POSTERIOR_PROB(list_log_mod_evid = list(mod1 = list_is_log_ev_sseb,
...
#MODEL 3: SSNB
#***********************
vec_post_probs_hm3 = GET_AGG_POSTERIOR_PROB(list_log_mod_evid = list(mod1 = list_is_log_ev_ssnb,
