...
#RUN POSTERIOR PROBS I
post_probs_base = GET_AGG_POSTERIOR_PROBABILITES(num_models = 4, FLAG_BASELINE = TRUE, list_log_mod_evid = list(model_ev_base,
                                                                                                                model_ev_ssnb, model_ev_sseb,
                                                                                                                model_ev_ssib))

post_probs_ssnb = GET_AGG_POSTERIOR_PROBABILITES(num_models = 4, list_log_mod_evid = list(model_ev_ssnb,
                                                                                          model_ev_base, model_ev_sseb,
                                                                                          model_ev_ssib))



post_probs_sseb = GET_AGG_POSTERIOR_PROBABILITES(num_models = 4, list_log_mod_evid = list(model_ev_sseb,
...
post_probs_ssib = GET_AGG_POSTERIOR_PROBABILITES(num_models = 4, list_log_mod_evid = list(model_ev_ssib,
                                                                                          model_ev_base, model_ev_ssnb, 
                                                                                          model_ev_sseb))
#PLOT
#model_ev_method = 'IS'
