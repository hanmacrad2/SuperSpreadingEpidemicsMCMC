...
plot.ts(data_ssebI)
run_number = 1
saveRDS(data_sseb, file = paste0(OUTER_FOLDER, 'epi_data_', model_type, '_', run, '.rds'))
...
# 1. RUN BASELINE MCMC
#**********************
RUN_MCMC_MULTIPLE_TIMES(data_sseb, OUTER_FOLDER, run_number = 1, n_repeats = 100, n_mcmc = 50000,
