...
data_nz = 'NZ_DATA_WAIT_21_SUBSET_II/'
data_nz = 'NZ_DATA_WAIT_21_SUBSET_I/'
data_nz = 'CM_08_21_SUB_1'
data_nz = 'NZ_DATA_WAIT_21/'
OUTER_FOLDER = paste0(PROJECT_FOLDER, data_nz)
print(OUTER_FOLDER)
...
data_wait_08_21 = data_wait_08_21[2:(length(data_wait_08_21)-1)]
data_wait_08_21
...
# 4. RUN SSIR MCMC
#**********************
RUN_MCMC_MULTIPLE_TIMES(data_wait_08_21, OUTER_FOLDER, run_number = run, n_repeats = 50, n_mcmc = 50000,
...
mcmc_baseline =  readRDS(file = paste0(CURRENT_FOLDER, 'mcmc_', tolower(model_type), '_', i,'.rds'))
