...
R0 = 1.2
k = 0.4
file_name = '_data_sse_50_12_04.rds'
data_sse = SIMULATE_EPI_SSE(num_days = num_days, R0 = R0, k = k)
plot.ts(data_sse, main = paste0('SSE Data, R0 = ', R0, ', k = ', k))
saveRDS(data_sse, paste0(DATA_FOLDER, file_name))
...
data_sse = SIMULATE_EPI_SSE(num_days = 50, R0 = 1.3, k = 0.6)
...
R0 = 1.2
k = 0.1
file_name = 'data_ssi_50_1_2_0_1.rds'
...
file_name = 'data_sseb_07_05_10.rds'
data_sseb3 = SIMULATE_EPI_SSEB(num_days = 50, alphaX = 0.7, betaX = 0.05, gammaX = 10)
plot.ts(data_sseb3, main = 'SSE-B Data al: 0.7, be:0.05, ga:10' )#, R0 = 1.2')
EPI_DATA = data_sseb
saveRDS(data_sseb3, paste0(DATA_FOLDER, file_name))
data_sseb3 = readRDS(paste0(DATA_FOLDER, file_name))
...
#*********************************************
#***********************************************
DATA_FOLDER = paste0(DATA_FOLDER, '/SSIB/')
